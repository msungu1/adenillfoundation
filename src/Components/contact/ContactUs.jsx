      ...
      <main className="contact-main split-layout">
          ...
          <div className="contact-info-section">
            ...
            <div className="info-grid">
              <div className="info-card">
                ...
                <p><strong>Our Address</strong><br />Nairobi, Kenya</p>
              </div>
              <div className="info-card">
              ...
              <div className="info-card">
                ...
                <p><strong>Email Address</strong><br />
                  <a href="mailto:adennilfoundation@gmail.com">adennilfoundation@gmail.com</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="contact-social">
          ...
          <div className="social-links">
            <a href="https://facebook.com/adennilfoundation" target="_blank" rel="noopener noreferrer">
              <span className="material-symbols-outlined">facebook</span> Facebook
            </a>
            <a href="https://twitter.com/adennilfoundation" target="_blank" rel="noopener noreferrer">
              <span className="material-symbols-outlined">alternate_email</span> Twitter
            </a>
            <a href="https://instagram.com/adennilfoundation" target="_blank" rel="noopener noreferrer">
              <span className="material-symbols-outlined">photo_camera</span> Instagram
            </a>
            <a href="https://linkedin.com/company/adennilfoundation" target="_blank" rel="noopener noreferrer">
        ...
        <section className="contact-faq">
          ...
          <div className="faq-item">
            ...
            <p>Fill out the form above or email us directly. We’ll guide you through the process.</p>
          </div>
          <div className="faq-item">
            <h4>Where does my donation go?</h4>
            <p>100% of donations fund housing, counseling, and job training programs.</p>
          </div>
          <div className="faq-item">
            <h4>Can organizations partner with you?</h4>
            <p>Yes! We welcome collaborations with corporates, NGOs, and community groups.</p>
          </div>
        </section>
      </main>
        {/* Footer */}
